...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.filebrowserImageBrowseUrl = '/Areas/Admin/assets/js/plugin/ckfinder.html?Types=Images';
    config.filebrowserFlashBrowseUrl = '/Areas/Admin/assets/js/plugin/ckfinder.html?Types=Flash';
